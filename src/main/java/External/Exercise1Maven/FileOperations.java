...
public class FileOperations {
	 ...
	 */
	public static HashMap<String, T3Return> loadT3ReturnsFromCsv(String filePath, boolean isOutputToConsole)
	{
		try {
			String row = "";
			...
			while (( row = csvReader.readLine()) != null) {
		    	...
		    	else System.out.println("ERROR: Invalid T3 return found on line: " + lineNumber);
			...
			System.out.println("Import Complete. " + returnList.size() + " T3 returns have been imported.");
			return returnList;
		} catch (IOException e) { 
