...
public class ReturnSubmissionView extends JFrame implements ActionListener {
	...
	private static final org.apache.logging.log4j.Logger logger = LogManager.getLogger(ReturnSubmissionView.class);

	//Fields
	//TODO: Should add HashMap<String, T3Return> to hold the imported CSV records. Add to constructor as well
//	private static final Logger logger = (Logger) LogManager.getLogger(ReturnSubmissionView.class);
	...
	public T3Return processSubmission() {
		...
		else
		{
			...
			logger.info("STATUS: Accepted return"); 
